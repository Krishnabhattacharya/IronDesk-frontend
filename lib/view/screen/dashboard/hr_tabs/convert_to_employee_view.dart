...
class _ConvertToEmployeeViewState extends State<ConvertToEmployeeView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Convert to Employee", style: GoogleFonts.montserrat(fontWeight: FontWeight.bold, color: Colors.indigo)),
        centerTitle: true,
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(widget.userData?["name"] ?? "User Name", style: GoogleFonts.inter(fontWeight: FontWeight.bold)),
                      Text(widget.userData?["email"] ?? "email@example.com", style: GoogleFonts.inter(color: Colors.grey[700])),
                    ],
                  )
                ],
              ),
