...
/// @nodoc
mixin _$LoginUserResponseModel {
...
/// Create a copy of LoginUserResponseModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LoginUserResponseModelCopyWith<LoginUserResponseModel> get copyWith => _$LoginUserResponseModelCopyWithImpl<LoginUserResponseModel>(this as LoginUserResponseModel, _$identity);

  /// Serializes this LoginUserResponseModel to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginUserResponseModel&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.data, data) || other.data == data)&&(identical(other.message, message) || other.message == message)&&(identical(other.success, success) || other.success == success));
}
...
@override
String toString() {
  return 'LoginUserResponseModel(statusCode: $statusCode, data: $data, message: $message, success: $success)';
}
...
/// @nodoc
abstract mixin class $LoginUserResponseModelCopyWith<$Res>  {
  factory $LoginUserResponseModelCopyWith(LoginUserResponseModel value, $Res Function(LoginUserResponseModel) _then) = _$LoginUserResponseModelCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$LoginUserResponseModelCopyWithImpl<$Res>
    implements $LoginUserResponseModelCopyWith<$Res> {
  _$LoginUserResponseModelCopyWithImpl(this._self, this._then);

  final LoginUserResponseModel _self;
  final $Res Function(LoginUserResponseModel) _then;
...
/// Adds pattern-matching-related methods to [LoginUserResponseModel].
extension LoginUserResponseModelPatterns on LoginUserResponseModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LoginUserResponseModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LoginUserResponseModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LoginUserResponseModel value)  $default,){
final _that = this;
switch (_that) {
case _LoginUserResponseModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LoginUserResponseModel value)?  $default,){
final _that = this;
switch (_that) {
case _LoginUserResponseModel() when $default != null:
return $default(_that);case _:
...
class _LoginUserResponseModel implements LoginUserResponseModel {
  const _LoginUserResponseModel({@JsonKey(name: "statusCode") this.statusCode, @JsonKey(name: "data") this.data, @JsonKey(name: "message") this.message, @JsonKey(name: "success") this.success});
  factory _LoginUserResponseModel.fromJson(Map<String, dynamic> json) => _$LoginUserResponseModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$LoginUserResponseModelCopyWith<_LoginUserResponseModel> get copyWith => __$LoginUserResponseModelCopyWithImpl<_LoginUserResponseModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LoginUserResponseModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginUserResponseModel&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.data, data) || other.data == data)&&(identical(other.message, message) || other.message == message)&&(identical(other.success, success) || other.success == success));
}
...
/// @nodoc
abstract mixin class _$LoginUserResponseModelCopyWith<$Res> implements $LoginUserResponseModelCopyWith<$Res> {
  factory _$LoginUserResponseModelCopyWith(_LoginUserResponseModel value, $Res Function(_LoginUserResponseModel) _then) = __$LoginUserResponseModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "statusCode") int? statusCode,@JsonKey(name: "data") Data? data,@JsonKey(name: "message") String? message,@JsonKey(name: "success") bool? success
});
...
/// @nodoc
class __$LoginUserResponseModelCopyWithImpl<$Res>
    implements _$LoginUserResponseModelCopyWith<$Res> {
  __$LoginUserResponseModelCopyWithImpl(this._self, this._then);

  final _LoginUserResponseModel _self;
  final $Res Function(_LoginUserResponseModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? statusCode = freezed,Object? data = freezed,Object? message = freezed,Object? success = freezed,}) {
  return _then(_LoginUserResponseModel(
statusCode: freezed == statusCode ? _self.statusCode : statusCode // ignore: cast_nullable_to_non_nullable
as int?,data: freezed == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as Data?,message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String?,success: freezed == success ? _self.success : success // ignore: cast_nullable_to_non_nullable
...
@JsonKey(name: "user") User? get user;@JsonKey(name: "accessToken") String? get accessToken;@JsonKey(name: "refreshToken") String? get refreshToken;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Data&&(identical(other.user, user) || other.user == user)&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken)&&(identical(other.refreshToken, refreshToken) || other.refreshToken == refreshToken));
}
...
@useResult
$Res call({
@JsonKey(name: "user") User? user,@JsonKey(name: "accessToken") String? accessToken,@JsonKey(name: "refreshToken") String? refreshToken
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "user")  User? user, @JsonKey(name: "accessToken")  String? accessToken, @JsonKey(name: "refreshToken")  String? refreshToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Data() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "user")  User? user, @JsonKey(name: "accessToken")  String? accessToken, @JsonKey(name: "refreshToken")  String? refreshToken)  $default,) {final _that = this;
switch (_that) {
case _Data():
return $default(_that.user,_that.accessToken,_that.refreshToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "user")  User? user, @JsonKey(name: "accessToken")  String? accessToken, @JsonKey(name: "refreshToken")  String? refreshToken)?  $default,) {final _that = this;
switch (_that) {
case _Data() when $default != null:
return $default(_that.user,_that.accessToken,_that.refreshToken);case _:
  return null;
...
class _Data implements Data {
  const _Data({@JsonKey(name: "user") this.user, @JsonKey(name: "accessToken") this.accessToken, @JsonKey(name: "refreshToken") this.refreshToken});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Data&&(identical(other.user, user) || other.user == user)&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken)&&(identical(other.refreshToken, refreshToken) || other.refreshToken == refreshToken));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Company&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email));
}
...
class _Company implements Company {
  const _Company({@JsonKey(name: "_id") this.id, @JsonKey(name: "name") this.name, @JsonKey(name: "email") this.email});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Company&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email));
}
